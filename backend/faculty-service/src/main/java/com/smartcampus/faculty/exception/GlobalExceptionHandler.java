...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleNotFound(FacultyNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> handleDuplicate(DuplicateFacultyException ex, HttpServletRequest request) {
